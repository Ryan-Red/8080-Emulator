...
int Disassemble8080Ops(unsigned char* codebuffer, int pc){
    ...
    switch(*code){
        ...
        case 0x22: printf("SHLD addr,#$%02x%02x",code[2],code[1]); opbyte = 3; break;
        ...
        case 0x2a: printf("LHLD addr,#%02x%02x",code[2],code[1]); opbyte = 3; break;
        case 0x2b: printf("DCX  H"); break;


        case 0x2c: printf("INR  L"); break;
        case 0x2d: printf("DCR  L"); break;
        case 0x2e: printf("MVI  L,#$%02x",code[1]); opbyte = 2; break;
        case 0x2f: printf("CMA"); break;

        case 0x30: printf("-"); break;

        case 0x31: printf("LXI  SP,#$%02x%02x",code[2],code[1]); opbyte = 3; break;
        case 0x32: printf("STA addr,#$%02x%02x",code[2],code[1]); opbyte = 3; break;
        case 0x33: printf("INX  SP"); break;
        case 0x34: printf("INR  M"); break;
        case 0x35: printf("DCR  A"); break;
        case 0x36: printf("MVI  M,#$%02x",code[1]); opbyte = 2; break;
        case 0x37: printf("STC"); break;

        case 0x38: printf("-"); break;

        case 0x39: printf("DAD  SP"); break;
        case 0x3a: printf("LDA addr,#%02x%02x",code[2],code[1]); opbyte = 3; break;
        case 0x3b: printf("DCX  SP"); break;
        case 0x3c: printf("INR  A"); break;
        case 0x3d: printf("DCR  A"); break;
        case 0x3e: printf("MVI  A,#$%02x",code[1]); opbyte = 2; break;
        ...
        case 0xa8: printf("SBB  B"); break;
        case 0xa9: printf("SBB  C"); break;
        case 0xaa: printf("SBB  D"); break;
        case 0xab: printf("SBB  E"); break;
        case 0xac: printf("SBB  H"); break;
        case 0xad: printf("SBB  L"); break;
